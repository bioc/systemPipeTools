...
```{r exploreDDSplot, eval=TRUE}
exploreDDSplot(countMatrix, targets, cmp = cmp[[1]], preFilter = NULL, 
               samples = c("M12A", "A12A"), scattermatrix = FALSE)
...
GLMplot(exploredds_r, plotly = FALSE, savePlot = TRUE, filePlot = "GLM.pdf")
```
