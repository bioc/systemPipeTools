---
title: "SPtools: Data Visualizations" 
...
vignette: |
  ...
  %\VignetteIndexEntry{SPtools: Data Visualizations}
...
*SPtools* package extends the widely used *systemPipeR* (SPR) workflow environment 
with enhanced tools kit for data visualization, including utilities to automate 
the analysis of differentially expressed genes (DEGs).
*SPtools* provides functions for data transformation and data exploration via 
scatterplots, hierarchical clustering heatMaps, principal component analysis, 
multidimensional scaling, generalized principal components, MA plots, volcano plot, 
...
egularized-logarithm transformation or `rlog` (@Love2014-sh). 
...
function and theresult is plotted as a dendrogram, as follows:
...
generated within the `DESeq2` package. It uses, by default, a `Pearson` 
